...
#import "ReligionViewController.h"
#import "EventosTableViewCell.h"
#import "ViewController.h"

@interface ReligionViewController ()

@end

@implementation ReligionViewController
...
- (void) retrieveFromParse {
    ...
    PFQuery *retrieveColors = [PFQuery queryWithClassName:@"Religion"];
